...
namespace chessEngine
{
   ...
   public:
       ...
       * @attention This only writes the white pieces, replacing the black pieces by a space.
       * @param board The board to write.
       */
       ...
       * @attention This only writes the black pieces, replacing the white pieces by a space.
       * @param board The board to write.
       */
